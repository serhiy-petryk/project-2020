// From http://www.codeproject.com/KB/combobox/DragDropListBox.aspx by Oliwan
...
namespace DGWnd.ThirdParty.Oli {
  ...
  public class DragDropCheckedListBox : CheckedListBox, IDragDropSource {
    ...
    public virtual void OnDropped(DroppedEventArgs e) {
      EventHandler<DroppedEventArgs> dropEvent = Dropped;
      if (dropEvent != null) {
        dropEvent(this, e);
      }
    }
    ...
    protected override void OnDragDrop(DragEventArgs drgevent) {
      ...
      e.Source = src;
      e.Target = this;
      e.DroppedItems = srcItems;
      OnDropped(e);

      // Notify the source (the other control).
      if (operation != DropOperation.Reorder) {
        e = new DroppedEventArgs();
        e.Operation = operation == DropOperation.MoveToHere ? DropOperation.MoveFromHere : DropOperation.CopyFromHere;
        e.Source = src;
        e.Target = this;
        e.DroppedItems = srcItems;
        src.OnDropped(e);
