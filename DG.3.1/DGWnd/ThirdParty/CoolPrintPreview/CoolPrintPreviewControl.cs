...
namespace DGWnd.ThirdParty.CoolPrintPreview {
  ...
  //        _doc.BeginPrint += new PrintEventHandler(_doc_BeginPrint);
//          _doc.
      ...
      double d1 = sw1.Elapsed.TotalMilliseconds;
    }
  ...
  //    _isPrinting = true;
      ...
      switch (ps.PrintRange) {
        case PrintRange.Selection:
          if (Document.PrinterSettings.PrintRange != PrintRange.Selection)
            Document.PrinterSettings.PrintRange = PrintRange.Selection;
          Document.Print();
          return;
        case PrintRange.AllPages:
          if (Document.PrinterSettings.PrintRange != PrintRange.AllPages)
