...
namespace DGUI.Mwi
{
    ...
    public partial class MwiContainer : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<WindowTabViewModel> WindowTabs { get; set; } = new ObservableCollection<WindowTabViewModel>();

        public WindowTabViewModel SelectedWindowTab
        {
            get => ActiveMwiChild?.Tab;
            set
            {
                if (value != null)
                    ActiveMwiChild = value.MwiChild;
            }
        }
        ...
        public MwiChild ActiveMwiChild
        {
            ...
            set
            {
                ...
                OnPropertyChanged(new[] { nameof(ActiveMwiChild), nameof(SelectedWindowTab), nameof(ScrollBarKind) });
        ...
        private void Children_OnCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Remove:
                    ...
                    WindowTabs.Remove(oldChild.Tab);
        ...
        public void OnPropertyChanged(string[] propertyNames) => propertyNames.AsParallel().ForAll(propertyName =>
