...
namespace DGUI.Themes
{
    public class ThemeInfo
    {
        public static ThemeInfo[] Themes =
        {
            new ThemeInfo("Windows10", "Стиль Windows 10", null, new[] { "/Themes/Wnd10.xaml"}),
            new ThemeInfo("Windows7", "Стиль Windows 7", null, new[] { "/Themes/Wnd7.xaml"})
