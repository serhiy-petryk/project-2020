...
namespace DGUI.Controls
{
    ...
    // <Thumb x:Name="DragThumb" Height="30" VerticalAlignment="Top" Opacity="0" controls:TextBlockExt.AutoTooltipTarget="{Binding ElementName=Header}" ...
